...
import com.github.honestlygroovy.ophidiavenom.SnowballUserManager;
	...
	public void onProjectileMoved(ProjectileMoved projectileMoved)
	{
		...
		for (Player player : playerDictionary.values())
		{
			...
			if (playerWp.distanceTo2D(projectileWP) <= 2)
			{
				...
				{
					client.addChatMessage(ChatMessageType.PUBLICCHAT, OPHIDIAVENOM, player.getName() + " already kicked you!", null);
				}
			}
		}
	}
